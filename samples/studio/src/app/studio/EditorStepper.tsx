            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <Step key="context-info">
                        ...
                        <StepContent>
                            <Typography>
                                ...
                                application needs to share about current user
                                session
                            </Typography>
                            <div className={classes.actionsContainer}>
                                <div>
                    ...
                    <Step key="api-info">
                        ...
                        <StepContent>
                            <Typography>
                                Define parameters needed for impersonated access
                                to Outreach API
                            </Typography>
                            <div className={classes.actionsContainer}>
                                <div>
                    ...
                    <Step key="config-info">
                        ...
                        <StepContent>
                            <Typography>
                                Defines configuration values Outreach user needs
                                to provide during the installation
                            </Typography>
                            <div className={classes.actionsContainer}>
                                <div>
                                    <Button
