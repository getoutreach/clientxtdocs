    ...
    <div className={classes.info}>
      ...
      <div className={classes.row}>
        ...
        <TextField
          ...
          value={editorStore.selectedManifest?.api?.redirectUri || ""}
          onChange={(e) => editorStore.setApiRedirectUrl(e.target.value)}
        ></TextField>
      </div>
      <div className={classes.row}>
        <TextField
          ...
          variant="outlined"
          value={editorStore.selectedManifest?.api?.token || ""}
          onChange={(e) => editorStore.setApiTokenEndpoint(e.target.value)}
        ></TextField>
        <TextField
          className={classes.textField}
          fullWidth={true}
          ...
          value={editorStore.selectedManifest?.api?.connect || ""}
          onChange={(e) => editorStore.setApiConnectEndpoint(e.target.value)}
        ></TextField>
      </div>
    </div>
  );
