...
const ApiInfo: React.FC = observer(() => {
    ...
    const ScopesEditor: React.FC = () => {
        const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
            console.debug(
                `Scope selected - ${event.target.value} -> ${event.target.checked}`
            );
        };
        ...
        return (
            <div className={classes.scopes}>
                ...
                <Typography variant="caption" style={{ marginBottom: 8 }}>
                    Define one or more Outreach API scopes which your
                    application will need. To learn more click
    ...
    const ApiInfoEditor: React.FC = () => {
        return (
            <div className={classes.info}>
                <Typography variant="h6">API info</Typography>
                <Typography variant="caption" style={{ marginBottom: 8 }}>
                    Outreach Application ID and redirect uri are values created
                    by Outreach. To learn more read{' '}
