...
import { Scopes } from '@outreach/client-addon-sdk';
...
const ScopesEditor: React.FC = observer(() => {
    ...
    const isChecked = (scope: Scopes) => {
        ...
        return (
            editorStore.selectedManifest.api.scopes.findIndex(
                (p) => p === scope
            ) > -1
        );
    };
                ...
                <FormGroup row={true}>
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CALL_DISPOSITIONS_DELETE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CALL_DISPOSITIONS_WRITE
                                )}
                ...
                <FormGroup row={true}>
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORIES_DELETE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORIES_WRITE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORIES_READ
                                )}
                ...
                <FormGroup row={true}>
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_ALL
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_DELETE
                                )}
                                value={
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_DELETE
                                }
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_WRITE
                                )}
                                value={
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_WRITE
                                }
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.CONTENT_CATEGORY_MEMBERSHIPS_READ
                                )}
                ...
                <FormGroup row={true}>
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_PROSPECT_ROLES_ALL
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_PROSPECT_ROLES_DELETE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_PROSPECT_ROLES_WRITE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_PROSPECT_ROLES_READ
                                )}
                ...
                <FormGroup row={true}>
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_STAGES_DELETE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_STAGES_WRITE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.OPPORTUNITY_STAGES_READ
                                )}
                ...
                <FormGroup row={true}>
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.SEQUENCE_TEMPLATES_DELETE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.SEQUENCE_TEMPLATES_WRITE
                                )}
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                checked={isChecked(
                                    Scopes.SEQUENCE_TEMPLATES_READ
                                )}
