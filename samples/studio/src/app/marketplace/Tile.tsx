  ...
  return (
    <div id="tile-context-container" className={classes.contextMenu}>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleOpenExtension}>Open extension</MenuItem>
        <MenuItem onClick={handleDeleteClick}>Delete extension</MenuItem>
        <Divider />
...
const Tile: React.FC<ITitleProps> = observer((props: ITitleProps) => {
  ...
  return (
    <div
      id="tile-root"
      className={!focused ? classes.root : `${classes.root} ${classes.focused}`}
